...
def make_db(subd, bot_token, chat_list, message_type, host, port, username, password, database, start, add_name, err429, backfill_days, platform):
    ...
    if subd_lower in ('mysql', 'my', 'mariadb'):
        from .mysql import Mysql
        return Mysql(bot_token, chat_list, message_type, host, port, username, password, database, start, add_name, err429, backfill_days, platform)
